...
<p align="center">
  <a href="https://github.com/haorui-lab/weibo-follow-flow/releases"><img src="https://img.shields.io/badge/version-0.7.2-orange.svg?style=flat-square" alt="Version"></a>
...
- 💬 **统一轻量反馈气泡（Toast）**：
  - 关注与取关均采用静默底层 API，彻底告别微博官方臃肿的大弹窗打扰；
  - 操作成功后统一呈现优雅的半透明深色毛玻璃提示（“关注成功” / “已取消关注”），极速反馈且绝不阻挡视线与点击。
...
| 状态 | 图标符号 | 视觉表现 | 交互行为 |
| :--- | :---: | :--- | :--- |
| **未关注** | `+` | 纤细中性灰加号，悬浮高亮微博经典橙（`#ff8200`） | 点击立即 **关注**（统一触发轻量“关注成功”气泡） |
| **已关注** | `•` | 极简微灰圆点，与微博辅助色一致，悬浮变红 `−` 提示 | 点击立即 **取关**（统一触发轻量“已取消关注”气泡） |
